...
class AllReportController extends Controller
{
    ...
    public function allReportEditStore(Request $request)
    {
        ...
        $input['bargraph_fake']=implode(',',$bargraph_fake);
        $input['bargraph_color']=implode(',',$bargraph_color);
        $report_description_1 = $input['report_description_1'];
        $report_description_2 = $input['report_description_2'];
        $report_description_3 = $input['report_description_3'];
        $patterns = array();
        $patterns[0] ='/h2/';
        $patterns[1] ='/h3/';
        $patterns[2] ='/h4/';
        ...
        $replacements[1] = 'h2';
        $replacements[2] = 'h3';
        $report_description_1 = preg_replace($patterns, $replacements, $report_description_1);
        $report_description_2 = preg_replace($patterns, $replacements, $report_description_2);
        $report_description_3 = preg_replace($patterns, $replacements, $report_description_3);
        //$report_description_1 = str_replace('<h2>','<h1>',$report_description_1,1);
     
        //$report_description_1 = preg_replace('/h2/', 'h1', $report_description_1, 1);
        $input['report_description_1'] = $report_description_1;
        $input['report_description_2'] = $report_description_2;
        $input['report_description_3'] = $report_description_3;
