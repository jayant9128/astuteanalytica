...
<aside class="app-sidebar">
    <div class="app-sidebar__user">
        ...
        <div>
            ...
            <p class="app-sidebar__user-designation">Publisher Panel</p>
        </div>
    </div>
    <ul class="app-menu">

        <li><a class="app-menu__item" href="#"><i class="app-menu__icon fas fa-tachometer-alt"></i><span class="app-menu__label">Dashboard</span></a></li>
