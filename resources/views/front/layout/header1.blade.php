         ...
         <div class="sticky-navbar">
            <div class="container">
               <div class="logo-box">
                  ...
                  <!-- <img class="logo-two lazyload" loading="lazy" data-src="{{URL::asset('public/front/images/logo/logo-2.png')}}" alt="Astute Analytica Logo"> -->
                  <img class="logo-two" src="https://www.astuteanalytica.com/public/front/images/logo/logo-2.png" alt="Astute Analytica Logo">
                  </a>
               </div>
        ...
        <div class="modal-content">
            <div class="search-screen">
                ...
                <form class="input-search" action="{{url('searchReport')}}" method="post">
                    @csrf
                    <input type="search" name="searchData" placeholder="Search Here.. " required id="searchTextBox" onkeyup="checkSearchSystem(this.value)">
