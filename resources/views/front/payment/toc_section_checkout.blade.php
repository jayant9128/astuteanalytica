            ...
            <div class="row">
                ...
                <div class="col-lg-6 information-entry">
                    ...
                    <div class="cart-summary-box">
                         ...
                         <h6 class="mt-2 text-danger">Report ID : {{$data->report_id}}</h6>
                                ...
                                <table class="cart-table">
                                    <tbody>
                                       ...
                                       <tr>
                                           ...
                                           <td class="text-dark font-weight-bold">$ {{$am}}</td>
                                       </tr>
                    ...
                    <input type="hidden" name="amount" value="{{Crypt::encryptString($am)}}">
                    <input type="hidden" name="toc_section" value="{{Crypt::encryptString($toc)}}">
                    <h2 class="main-heading inner-heading">PAYMENT</h2>
                    <div class="cart-summary-box">
                        <div class="custom-control d-inline custom-radio mb-20">
