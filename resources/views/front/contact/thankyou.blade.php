...
@section('content')
<link rel="preload" href="{{ URL::asset('public/front/css/thankyou.css') }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
<noscript><link rel="stylesheet" href="{{ URL::asset('public/front/css/thankyou.css') }}"></noscript>
            ...
            <div class="row justify-content-center">
                <div class="col-md-9">
                    <div class="error-item text-center">
                        <h1>Thank You</h1>
                        <p class="mb-0">Thank you for your request, it has been received successfully. Our executive will contact you soon. If you are looking for a specific report feel free to contact our representative @ +1 888 212 3539 (US) / +91 999 711 2116 (REST OF WORLD).
                        </p>
                       <p> </p>
