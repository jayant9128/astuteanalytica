    ...
    <div class="row bg-white py-3">
        <div class="col-md-12">
            ...
            <div class="card-box">
                ...
                <form action="{{route('tocEditSave')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="toc_id" value="{{$data->toc_id}}">
                    <div class="row col-sm-12">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="amount" autofocus required placeholder="Amount" value="{{$data->amount}}">
                            </div>
                        </div>
