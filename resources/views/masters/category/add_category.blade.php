                    ...
                    <div class="row col-sm-12">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="title" autofocus required placeholder="Category Title">
                            </div>
                        </div>
                       ...
                       <!-- <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="meta_keyword" required placeholder="Meta Keyword">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" required placeholder="Meta Description "></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="details" required placeholder="Category Description Title"></textarea>
                            </div>
                        </div>
